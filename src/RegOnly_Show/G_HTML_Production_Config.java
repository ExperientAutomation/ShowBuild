...
public class G_HTML_Production_Config extends TestSuiteBase {
	...
	public void A_HTMLProdConfig() throws Exception {
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id='DropDownListReport']")));
		Assert.assertTrue(driver.findElement(By.xpath("//*[@id='DropDownListReport']")).isDisplayed(),"Failed to display HTML_Production_Config Page");
