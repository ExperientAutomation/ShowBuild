...
//	}
	...
	@Test
	public void sendEmail(String screenshotPath, String moduleName){
...
//        			InternetAddress.parse("mahesh.mishra@experient-inc.com,ladukeshm@infinite.com,sreejak@infinite.com"));
        ...
        message.setSubject(moduleName + " has FAILED with the attached screenshot");
        //message.setText("PFA");
        ...
        String html = "<p>Hi,</p><p>PFA the screenshot for failure in "+moduleName+" .</p><p>Thanks,</p><p>Mahesh</p>";
