...
public class TestUtil {
	...
	public static void runTestCases(String suiteName, String testName) {
	...
	public static String getEnvUrl(String env) {
		...
		try {
			switch (env) {
			case "UATProd":
				url = TestBase.CONFIG.getProperty("UatProdURL");
				break;
			case "UATStage":
				url = TestBase.CONFIG.getProperty("UatStageURL");
				break;
			}
		} catch (Exception ex) {
			ex.printStackTrace();
